    ...
    const messages = [
      {
        role: "user",
        parts: [{
          text: `Translate the following text to English (and nothing but ENGLISH). If the text is already in English, return it as is. Only return the translated text, no additional commentary or explanations.
