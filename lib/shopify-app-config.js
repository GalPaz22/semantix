...
export const SHOPIFY_API_KEY = process.env.NEXT_PUBLIC_SHOPIFY_API_KEY || 'ed3834d550c5d814851e0ad46493ca2c';
export const SHOPIFY_API_SECRET = process.env.SHOPIFY_API_SECRET;

// App settings
export const APP_NAME = 'Semantix AI Search';
export const APP_URL = process.env.NEXT_PUBLIC_APP_URL || 'https://www.semantix.co.il';
