...
export default async function processShopifyDescriptions({ shopifyDomain, shopifyApiKey, shopifyApiPassword, dbName, categories, type: userTypes, softCategories }) {
  const logs = [];
