...
// Configure SSL/TLS settings for Node.js
process.env.NODE_TLS_REJECT_UNAUTHORIZED = '0'; // Temporarily disable SSL verification
process.env.NODE_OPTIONS = '--tls-cipher-list=ECDHE+AESGCM:ECDHE+CHACHA20:DHE+AESGCM:DHE+CHACHA20:!aNULL:!MD5:!DSS';
