...
export default async function processShopifyImages({ shopifyDomain, shopifyApiKey, shopifyApiPassword, dbName, categories, userTypes, softCategories, context }) {
  ...
  // Create Basic Auth token for API Key authentication
  ...
  while (hasNextPage) {
    const batchSize = 250; // Maximum allowed by Shopify GraphQL API
